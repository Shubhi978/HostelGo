...
class OutpassRecords(models.Model):
    ...
    proceeding_to = models.TextField()
...
class OutpassVerifierOutpassrecords(models.Model):
    roll_no = models.CharField(primary_key=True, max_length=100)
    status = models.IntegerField()

    class Meta:
        managed = False
        db_table = 'outpass_verifier_outpassrecords'
