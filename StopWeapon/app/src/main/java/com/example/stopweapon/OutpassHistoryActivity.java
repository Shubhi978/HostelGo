...
import com.example.stopweapon.adapter.OutpassHistoryRecyclerViewAdapter;
...
public class OutpassHistoryActivity extends AppCompatActivity {
    ...
    private OutpassHistoryRecyclerViewAdapter recyclerViewAdapter;
    private ArrayList<JSONObject> recordArrayList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_outpass_history);

        System.out.println("ENTERED OUTPASS HISTORY ACTIVITY");

        recyclerView = findViewById(R.id.rvHistory);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        recordArrayList = new ArrayList<>();
        recyclerViewAdapter = new OutpassHistoryRecyclerViewAdapter(OutpassHistoryActivity.this, recordArrayList);
    ...
    private class pgsqlcon extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                ...
                sql = "SELECT * FROM Outpass_Records WHERE date = '" + todaysDate + "' ORDER BY approved_time DESC";
